...
/***************************************************************************************************************************************************************************/
///char INPUT_DIRECTORY[]   = "//home//karbasip//";
///char OUTPUT_DIRECTORY[]  = "//home//karbasip//";
/***************************************************************************************************************************************************************************/
...
///char INPUT_FOLDER[]	   = "input_CTP404_4M";
///char OUTPUT_FOLDER[]         = "cuda_test";
...
/***************************************************************************************************************************************************************************/
int BYTES_PER_HISTORY	=	48;								// [bytes] Data size of each history, 44 for actual data and 4 empty bytes, for old data format
///int MAX_GPU_HISTORIES		= static_cast<int>(3200000);		// [#] Number of histories to process on the GPU at a time, based on GPU capacity
///int MAX_CUTS_HISTORIES		= static_cast<int>(3200000);
...
///int ITERATIONS				= 12;										// # of iterations through the entire set of histories to perform in iterative image reconstruction
...
///int DROP_BLOCK_SIZE			= static_cast<int>(320000);//3840// # of paths to use for each update: ART = 1, 

#define CONSTANT_CHORD_NORM		pow(VOXEL_WIDTH, 2.0)
double CONSTANT_LAMBDA_SCALE =	VOXEL_WIDTH * 0.001; //LAMBDA instead of 0.001
