...
__device__ void find_MLP_path_GPU(float*, double, unsigned int, double, double, double, double, double, double, double, double, double, double, double, float, unsigned int*, float&, int& );                        		//*
...
void drop_cuts_allocations()
{
	unsigned int size_floats		= sizeof(float) * DROP_BLOCK_SIZE;
	unsigned int size_ints			= sizeof(int) * DROP_BLOCK_SIZE;
	unsigned int size_bool			= sizeof(bool) * DROP_BLOCK_SIZE;
